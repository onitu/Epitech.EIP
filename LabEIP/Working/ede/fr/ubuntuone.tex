...
Les données stockées sur Ubuntu One sont envoyées sur le cloud Amazon S3. C'est notamment à cause de ce lien avec Amazon que le code du serveur d'Ubuntu One ne peut être libéré par Cannonical.
