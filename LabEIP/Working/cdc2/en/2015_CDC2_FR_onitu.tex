...
\fancypagestyle{EIP}
{
	...
	\fancyfoot[L]{\textcolor{epiBlue}{\textbf{\underline{\scriptsize{\leftmark}}}}}
	\fancyfoot[C]{}
	\fancyfoot[R]{
...
\thispagestyle{empty}
\vspace*{10mm}
\textbf{\emph{\textcolor{epiBlue}{\large{Document synopsis} } } } \\
...
\hline
	Subject & CDC2\\
\hline
	Keywords & Scope, Statement, Technologies, Seahorse\\
\hline
...
\textbf{\emph{\textcolor{epiBlue}{\large{Revisions table} } } }\\
...
\hline
	10/04/2013 & Alexandre Baron & All & New template\\
\hline
	03/05/2013 & Alexandre Baron & All & template update: Added the icon, changed colors\\
\hline
	04/05/2013 & Alexandre Baron & Headers, Footers & Added the "Onitu" icon, pushed the EIP logo up\\
\hline
	05/05/2013 & Antoine Rozo et Yannick Peroux & All & Spelling and formulation corrections\\
\hline
	06/05/2013 & Louis Roché & Title & Title correction\\
\hline
	15/05/2013 & Alexandre Baron & Template & Removed the icon, moved the titles to the lower left corner\\
\hline
\end{tabular}
...
\chapter{Description of the Working environement}
\thispagestyle{EIP} % seems mandatory
...
\chapter{Description of the different parts composing the software}
\thispagestyle{EIP} % seems mandatory
\input{architecture.tex}

\chapter{Description of the first level tests}
\thispagestyle{EIP} % seems mandatory
\input{tests_premier_niveau.tex}

\chapter{Description of the marketing and comunication strategies}
\thispagestyle{EIP} % seems mandatory
\input{marketing_communication.tex}

\chapter{Project's organisation}
\thispagestyle{EIP} % seems mandatory
