...
\fancypagestyle{empty}
{
	...
	\fancyhead[C]{\fontfamily{bch}\selectfont \textcolor{epiBlue}{\textbf{\underline{{\DocTitle}}}}}
	\fancyhead[R]{\includegraphics[height=35pt]{petitnuage.png} \fontfamily{bch}\selectfont \textcolor{epiBlue}{\textbf{\emph{\huge{Onitu}}}}}
...
\fancypagestyle{EIP}
{
	...
	\renewcommand{\footrulewidth}{1pt}
	\fancyhead[L]{\includegraphics[height=35pt]{logo_eip.png}}
	\fancyhead[C]{\fontfamily{bch}\selectfont \textcolor{epiBlue}{\textbf{\underline{\leftmark}}}}
	\fancyhead[R]{\includegraphics[height=35pt]{petitnuage.png} \fontfamily{bch}\selectfont \textcolor{epiBlue}{\textbf{\emph{\huge{Onitu}}}}}
