...
\newcommand{\SubTitle}{Gantt Chart and WBS (Work Breakdown Structure)}
...
\thispagestyle{empty}
\vspace*{10mm}
\textbf{\emph{\textcolor{epiBlue}{\large{Document description} } } } \\
...
\textbf{\emph{\textcolor{epiBlue}{\large{Revision table} } } }\\
...
\hline
        06/05/2013 & Louis Roché & Gantt & Added the EIP Lab milestones to the gant \\
\hline
        15/05/2013 & Louis Roché & Gantt & Added the workloads \\
\hline
	& & & \\
\hline
\end{tabular}
