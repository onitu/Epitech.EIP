...
\title{
	\huge{\textbf{\textcolor{epiBlue}{50 mots} } }\\
	\Large{\textbf{\emph{\textcolor{gray}{Description du projet en 50 mots} } } }
}
...
\hline
	05/02/2013 & Louis Roché & Toutes & Première version \\
\hline
	13/02/2013 & Louis Roché & Toutes & Version commune \\
\hline
	& & & \\
\hline
\end{tabular}
...
Onitu vous permet de stocker vos fichiers où vous le souhaitez, de les synchroniser et d'y accéder sans limites, où que vous soyez. Open-source, il s'agit d'une solution simple et sécurisée, vous donnant un contrôle total sur vos données. Grâce à sa compatibilité avec UbuntuOne, une mulitude de logiciels pourront directement être utilisés avec Onitu.
